...
//    }
    @PutMapping(value = "/uploadsp")
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    public @ResponseBody ResponseEntity<?> updateSanPham(@RequestParam("idsp") int idsp,@RequestParam("tensp") String tensp,
                                                      @RequestParam("giasp") String giasp, @RequestParam("thuonghieu") String thuonghieu
                                                    , @RequestParam("tinhtrang") String tinhtrang, @RequestParam("nguongoc") String nguongoc
                                                    , @RequestParam("khoiluong") String khoiluong
                                                    , @RequestParam("chitiet") String chitiet
                                                    //, @RequestParam("loaisp") String loaisp
                                                    , final @RequestParam("hinhanh") MultipartFile hinhanh){
